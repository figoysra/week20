...
const Products = () =>{
    ...
    // console.log(inputProducts.photoPriview)
    ...
    return(
        <div>
            {dataProducts.loadAll === true || dataProducts.errorAll === true ? (
                <Loading />
            ):(
                <>
                            ...
                            <Modal isOpen={modal} toggle={toggle} >
                                ...
                                <ModalBody>
                                    <Form onSubmit={handleSubmit}>
                                        ...
                                        <div className='d-flex flex-column align-items-center containerImage'>
                                            <div className='productImage'>
                                                <img width="auto" height={100} src={inputProducts.photoPriview === '' ? `${API_URL}/defaultImage.jpg` : inputProducts.photoPriview} alt="" />
                                            </div>
                                            <div className='middle'>
                                                <label className='text'>
                                                    Add Image
                                                    <Input type="file" required onChange={changeInputFile} className='uploadImage'  name="photo" placeholder="" />
                                                </label>
